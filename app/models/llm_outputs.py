...
class QueryPlanOutput(BaseModel):
    ...
    domain_category: str = Field(description="最适合的Arxiv领域分类，如cs.CL/cs.CV/cs.LG")
    research_scope: str = Field(description="研究边界说明")
    search_rationale: str = Field(description="选择这些query的原因，用于调试")
...
class ReviewOutput(BaseModel):
    ...
    specific_issues: List[IssueItem] = Field(description="具体问题列表")
